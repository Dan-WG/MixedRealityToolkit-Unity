...
namespace Paroxe.PdfRenderer.Internal.Viewer
{
    public class PDFViewerLeftPanel : UIBehaviour
    {
        ...
        public void SetActive(bool active)
        {
            ...
            {
                m_ViewerViewport = GetComponentsInParent<PDFViewer>(true)[0].m_Internal.Viewport;
            }
            if (m_HorizontalScrollBar == null)
            {
                m_HorizontalScrollBar = GetComponentsInParent<PDFViewer>(true)[0].m_Internal.HorizontalScrollBar;
            }
        ...
        {
            m_RectTransform = transform as RectTransform;
            m_ViewerViewport = GetComponentInParent<PDFViewer>().m_Internal.Viewport;
            m_HorizontalScrollBar = GetComponentInParent<PDFViewer>().m_Internal.HorizontalScrollBar;
